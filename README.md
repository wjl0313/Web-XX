...
当前已经抽取了装备、功法、战斗结算、队伍、首领、挂机与离线等纯玩法核心，但默认游戏运行时尚未脱离冻结 HTML，原生存档模型和回合编排也还没有达到承载新玩法的最终形态。因此本项目目前是“可回归的迁移基座”，不是“已经彻底模块化的新游戏架构”；后续玩法调整应按 `GAMEPLAY_CHANGE_GUIDE.md` 的新玩法规则层计划继续推进。
