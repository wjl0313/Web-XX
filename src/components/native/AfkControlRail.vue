    ...
    <template v-if="afk.isV2">
      ...
      <details class="legacy-side-panel" open>
        ...
        <div class="legacy-side-panel__body">
          <p>战斗中不能调息，只能用治疗功法或丹药回血。战后气血达到或低于阈值会自动调息至满；调息只恢复气血，不恢复法力。法力按当前场景灵力充沛度与神识随时间被动恢复，境界越高恢复越快，也可用回灵丹或回灵功法加速。调息期间不能寻敌、突破、秘境、洞府参悟或炼丹，但可以更换装备，并可消耗回春丹或法力施展已拥有的治疗功法加快恢复。</p>
